...
// Run component analysis first
try {
  require('./analyze-components.js');
} catch (error) {
  console.log('⚠️  Could not run component analysis:', error.message);
}

const overview = `# Finance Calculator Documentation
...
console.log('✅ Documentation overview created in docs/README.md');

console.log('\n🎉 Documentation generation complete!');
console.log('📂 Check the docs/ directory for all generated files');
