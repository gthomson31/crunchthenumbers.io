...
import { LoanInputs, LoanResults } from "@/lib/types/calculator";
...
export default function LoanCalculator() {
  ...
  useEffect(() => {
    const calculateLoan = () => {
      if (inputs.loanTerm <= 0 || inputs.loanAmount <= 0) {
        setResults({
          monthlyPayment: 0,
          totalInterest: 0,
          totalPayment: 0,
  ...
  const getLoanTypeIcon = () => {
    switch (inputs.loanType) {
      case "auto":
        return <CreditCard className="w-5 h-5 text-blue-600 mr-2" />;
      case "student":
        return <Calculator className="w-5 h-5 text-blue-600 mr-2" />;
      case "business":
        return <DollarSign className="w-5 h-5 text-blue-600 mr-2" />;
      default:
        return <Calculator className="w-5 h-5 text-blue-600 mr-2" />;
    }
  };
  ...
  const getLoanTypeDescription = () => {
    switch (inputs.loanType) {
      ...
      case "auto":
        return "Secured loan for vehicle purchase";
      case "student":
        return "Education financing loan";
      case "business":
  ...
  return (
    <div id="loan-calculator" className="max-w-7xl mx-auto p-6 bg-white">
      ...
      <div className="flex justify-end mb-6">
        <ExportButton
          data={{ inputs, results }}
          calculatorElementId="loan-calculator"
          className="no-print"
        />
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <p className="text-xl font-bold text-purple-600">
                  {formatCurrency(results.totalPayment, inputs.currency)}
                </p>
              </div>
              <div className="bg-white p-4 rounded-lg">
